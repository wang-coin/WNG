...
/**
 * Issue a currency on the WNG blockchain
 * <p>
 * A currency is the basic block of the WNG Monetary System it can be exchanged with WNG, transferred between accounts,
 ...
 * For {@link wng.CurrencyType#RESERVABLE} currency
 * <li>minReservePerUnitNQT - the minimum WNG value per unit to allow the currency to become active
 * For {@link wng.CurrencyType#RESERVABLE} currency
 ...
 * For {@link wng.CurrencyType#MINTABLE} currency
 * <li>maxDifficulty - for mint-able currency, the exponent of the final difficulty.
 * For {@link wng.CurrencyType#MINTABLE} currency
 * <li>algorithm - the hashing {@link wng.crypto.HashFunction algorithm} used for minting.
 * For {@link wng.CurrencyType#MINTABLE} currency
 * </ul>
 * <p>
 * Constraints
 * <ul>
 * <li>A given currency can not be neither {@link wng.CurrencyType#EXCHANGEABLE} nor {@link wng.CurrencyType#CLAIMABLE}.<br>
 * <li>A {@link wng.CurrencyType#RESERVABLE} currency becomes active once the blockchain height reaches the currency issuance height.<br>
 ...
 * When a {@link wng.CurrencyType#RESERVABLE} becomes active, in case it is {@link wng.CurrencyType#CLAIMABLE} the WNG used for
 * reserving the currency are locked until they are claimed back.
 * When a {@link wng.CurrencyType#RESERVABLE} becomes active, in case it is non {@link wng.CurrencyType#CLAIMABLE} the WNG used for
 * reserving the currency are sent to the issuer account as crowd funding.
 * <li>When issuing a {@link wng.CurrencyType#MINTABLE} currency, the number of units per {@link wng.http.CurrencyMint} cannot exceed 0.01% of the
 ...
 * difficulty increases linearly with the number units minted per {@link wng.http.CurrencyMint}<br>
 * </ul>
 *
 * @see wng.CurrencyType
 * @see wng.crypto.HashFunction
 */
