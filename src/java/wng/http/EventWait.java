...
import wng.http.EventListener.PendingEvent;
 ...
 * wng.apiEventTimeout will be used if no timeout value is specified or
 * if the requested timeout is greater than wng.apiEventTimeout.</li>
 * </ul>
 *
