...
public final class DbShellServlet extends HttpServlet {
    ...
    private static final String header =
            "<!DOCTYPE html>\n" +
                    ...
                    "<head>\n" +
                    "    <meta charset=\"UTF-8\"/>\n" +
                    "    <title>Wng H2 Database Shell</title>\n" +
    ...
    private static final String errorNoPasswordIsConfigured =
            "This page is password-protected, but no password is configured in wng.properties. " +
                    "Please set wng.adminPassword or disable the password protection with wng.disableAdminPassword";
    ...
    private static final String passwordFormWrongPassword = String.format(passwordFormTemplate, 
            "<p style=\"color:red\">The provided password does not match the value of wng.adminPassword. Please try again!</p>");
