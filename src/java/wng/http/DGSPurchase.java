...
import static wng.http.JSONResponses.INCORRECT_DELIVERY_DEADLINE_TIMESTAMP;
import static wng.http.JSONResponses.INCORRECT_PURCHASE_PRICE;
import static wng.http.JSONResponses.INCORRECT_PURCHASE_QUANTITY;
import static wng.http.JSONResponses.MISSING_DELIVERY_DEADLINE_TIMESTAMP;
...
public final class DGSPurchase extends CreateTransaction {
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) throws WngException {
        ...
        try {
            ...
            if (deliveryDeadline <= Wng.getEpochTime()) {
