...
import static wng.http.JSONResponses.FEATURE_NOT_AVAILABLE;
import static wng.http.JSONResponses.INCORRECT_DEADLINE;
import static wng.http.JSONResponses.INCORRECT_LINKED_FULL_HASH;
import static wng.http.JSONResponses.INCORRECT_WHITELIST;
import static wng.http.JSONResponses.MISSING_DEADLINE;
import static wng.http.JSONResponses.MISSING_SECRET_PHRASE;
import static wng.http.JSONResponses.NOT_ENOUGH_FUNDS;
...
abstract class CreateTransaction extends APIServlet.APIRequestHandler {
    ...
    private Appendix.Phasing parsePhasing(HttpServletRequest req) throws ParameterException {
        int finishHeight = ParameterParser.getInt(req, "phasingFinishHeight",
                Wng.getBlockchain().getHeight() + 1,
                Wng.getBlockchain().getHeight() + Constants.MAX_PHASING_DURATION + 1,
                true);
    ...
    final JSONStreamAware createTransaction(HttpServletRequest req, Account senderAccount, long recipientId,
                                            long amountNQT, Attachment attachment) throws WngException {
        ...
        try {
            Transaction.Builder builder = Wng.newTransactionBuilder(publicKey, amountNQT, feeNQT,
            ...
            } catch (WngException.NotYetEncryptedException ignore) {}
        ...
        } catch (WngException.NotYetEnabledException e) {
