...
import static wng.http.JSONResponses.MONITOR_ALREADY_STARTED;
import static wng.http.JSONResponses.UNKNOWN_ACCOUNT;
import static wng.http.JSONResponses.incorrect;

/**
 * Start a funding monitor
 * <p>
 * A funding monitor will transfer WNG, ASSET or CURRENCY from the funding account
 ...
 * <p>
 * WNG amounts are specified with 8 decimal places.  Asset and Currency decimal places
...
public final class StartFundingMonitor extends APIServlet.APIRequestHandler {
     ...
     * @throws  WngException        Unable to process request
     */
    @Override
