...
import static wng.user.JSONResponses.LOCK_ACCOUNT;
...
public final class UnlockAccount extends UserServlet.UserRequestHandler {
    ...
    JSONStreamAware processRequest(HttpServletRequest req, User user) throws IOException {
        ...
        if (account == null) {
            ...
            try (DbIterator<? extends Transaction> transactions = Wng.getTransactionProcessor().getAllUnconfirmedTransactions()) {
            ...
            int blockchainHeight = Wng.getBlockchain().getLastBlock().getHeight();
            try (DbIterator<? extends Block> blockIterator = Wng.getBlockchain().getBlocks(accountId, 0)) {
            ...
            try (DbIterator<? extends Transaction> transactionIterator = Wng.getBlockchain().getTransactions(accountId, (byte) -1, (byte) -1, 0, false)) {
