...
public interface Transaction {
    ...
    interface Builder {
        ...
        Transaction build() throws WngException.NotValidException;

        Transaction build(String secretPhrase) throws WngException.NotValidException;
    ...
    void validate() throws WngException.ValidationException;
