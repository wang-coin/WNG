...
public abstract class WngException extends Exception {

    protected WngException() {
        super();
    }

    protected WngException(String message) {
        super(message);
    }

    protected WngException(String message, Throwable cause) {
        super(message, cause);
    }

    protected WngException(Throwable cause) {
        super(cause);
    }

    public static abstract class ValidationException extends WngException {
    ...
    public static final class WngIOException extends IOException {

        public WngIOException(String message) {
            super(message);
        }

        public WngIOException(String message, Throwable cause) {
            super(message, cause);
        }
