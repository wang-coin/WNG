...
/**
 * Handle logging for the Wng node server
 */
public final class Logger {
     ...
     * The wng/conf/logging-default.properties and wng/conf/logging.properties configuration
    ...
    static {
        ...
        System.setProperty("java.util.logging.manager", "wng.util.WngLogManager");
        if (!(LogManager.getLogManager() instanceof WngLogManager)) {
            System.setProperty("java.util.logging.manager",
                    (oldManager != null ? oldManager : "java.util.logging.LogManager"));
        }
        if (! Boolean.getBoolean("wng.doNotConfigureLogging")) {
            try {
                Properties loggingProperties = new Properties();
                Wng.loadProperties(loggingProperties, "logging-default.properties", true);
                Wng.loadProperties(loggingProperties, "logging.properties", false);
                Wng.updateLogFileHandler(loggingProperties);
        ...
        log = org.slf4j.LoggerFactory.getLogger(wng.Wng.class);
        enableStackTraces = Wng.getBooleanProperty("wng.enableStackTraces");
        enableLogTraceback = Wng.getBooleanProperty("wng.enableLogTraceback");
    ...
    public static void shutdown() {
        if (LogManager.getLogManager() instanceof WngLogManager) {
            ((WngLogManager) LogManager.getLogManager()).wngShutdown();
        }
    }
