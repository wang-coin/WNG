...
public final class Convert {
    ...
    public static String rsAccount(long accountId) {
        return "WNG-" + Crypto.rsEncode(accountId);
    }
    ...
    public static String readString(ByteBuffer buffer, int numBytes, int maxLength) throws WngException.NotValidException {
        if (numBytes > 3 * maxLength) {
            throw new WngException.NotValidException("Max parameter length exceeded");
        }
    ...
    public static long parseWNG(String wng) {
        return parseStringFraction(wng, 8, Constants.MAX_BALANCE_WNG);
    }
