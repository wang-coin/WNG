...
import wng.WngException.WngIOException;
...
public class CountingInputReader extends FilterReader {
     ...
     * @throws  WngIOException      Maximum count exceeded
     */
    private void incCount(long c) throws WngIOException {
        count += c;
        if (count > limit)
            throw new WngIOException("Maximum size exceeded: " + count);
    }
}
