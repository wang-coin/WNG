...
/**
 * Java LogManager extension for use with Wng
 */
public class WngLogManager extends LogManager {

    /** Logging reconfiguration in progress */
    private volatile boolean loggingReconfiguration = false;

    /**
     * Create the Wng log manager
     *
     ...
     * done terminating the Wng processes.
     */
    public WngLogManager() {
        super();
    }
     ...
     * This allows us to continue to use logging facilities during Wng shutdown.
     */
    @Override
    public void reset() {
    ...
    /**
     * Wng shutdown is now complete, so call LogManager.reset() to terminate
     * the log handlers.
     */
    void wngShutdown() {
        super.reset();
