...
import wng.Wng;
import wng.env.service.WngService_ServiceManagement;
...
public class ManifestGenerator {
    ...
    public static void main(String[] args) {
        ...
        manifestGenerator.generate("./resource/wng.manifest.mf", Wng.class.getCanonicalName(), "./lib");
        String serviceClassName = WngService_ServiceManagement.class.getCanonicalName();
        serviceClassName = serviceClassName.substring(0, serviceClassName.length() - "_ServiceManagement".length());
        manifestGenerator.generate("./resource/wngservice.manifest.mf", serviceClassName, "./lib");
    }
