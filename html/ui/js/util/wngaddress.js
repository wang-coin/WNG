/*
    WNG address class, extended version (with error guessing).

    Version: 1.0, license: Public Domain, coder: WngChg (admin@wngchg.com).
*/
...
function WngAddress() {
	...
	this.set = function(adr, allow_accounts) {
		...
		if (adr.indexOf('WNG-') == 0) adr = adr.substr(4);
