...
var NRS = (function(NRS, $) {
	...
	$("#set_mandatory_approval_modal").on("show.bs.modal", function(e) {
		...
		var context = {
			labelText: "Amount WNG",
			labelI18n: "amount_wng",
			helpI18n: "approve_transaction_amount_help",
			inputName: "controlQuorumWNG",
			addonText: "WNG",
			addonI18n: "wng_unit"
		}
		var $elems = NRS.initModalUIElement($modal, '.phasing_only_amount_wng', 'simple_input_with_addon_modal_ui_element', context);
		...
		context['inputName'] = 'controlMinBalanceWNG';
		context['addonText'] = 'WNG';
		context['addonI18n'] = 'wng_unit';
		var $elems = NRS.initModalUIElement($modal, '.phasing_only_min_balance_wng', 'simple_input_with_addon_modal_ui_element', context);
		$elems.find('input').prop("disabled", true);
		$elems.hide();
