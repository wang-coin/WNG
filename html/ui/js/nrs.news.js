	...
	NRS.pages.news = function() {
      ...
      var settingsReddit = {
         ...
         "filter": function(entry, tokens) {
            return tokens.title.indexOf("Donations toward") == -1 && tokens.title.indexOf("WNG tipping bot has arrived") == -1
         },
         "ssl": ssl
      };

      $("#wngforum_news").rss("https://wngforum.org/index.php?type=rss;action=.xml", settings, NRS.newsLoaded);
      $("#reddit_news").rss("http://www.reddit.com/r/WNG/.rss", settingsReddit, NRS.newsLoaded);
      $("#wngcoin_blogspot_news").rss("http://wngcoin.blogspot.com/feeds/posts/default", settings, NRS.newsLoaded);
      $("#wnger_news").rss("http://wnger.org/feed/", settings, NRS.newsLoaded);
		NRS.pageLoaded();
	};
